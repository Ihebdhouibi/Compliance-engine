...
notif_service = """import { Injectable, signal } from "@angular/core";
...
export class NotificationService {
  ...
  private fetchNotifications() {
    ...
    return this.http.get<AppNotification[]>(
      environment.apiBaseUrl + "/api/v1/admin/notifications"
    ).pipe(catchError(() => of([])));
  }
...
with open("src/app/services/notification.service.ts", "w", encoding="utf-8") as f:
    f.write(notif_service)
print("notification.service.ts created!")
