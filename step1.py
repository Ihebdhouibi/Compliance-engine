import os
os.makedirs("src/app/features/chat", exist_ok=True)

# ── chat.service.ts ──────────────────────────────────────────
svc = open("src/app/services/chat.service.ts", "w", encoding="utf-8")
svc.write("""import { Injectable, signal } from \"@angular/core\";
